...
<body>
    <div class="container mt-2">
        <div class="row">
            ...
            @endif
            <form action="{{ route('listapp.update',$listapp->id)}}" method="POST"enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="codename" name="codename" value="{{$listapp->codename}}"class="form-control" placeholder="Codename">
                        @error('codename')
                        <div class="alert alert-danger">{{ $message}}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="address" name="address"value="{{$listapp->address}}" class="form-control" placeholder="Address">
                        @error('address')
                        <div class="alert alert-danger">{{ $message}}</div>
                        @enderror
                    </div>
